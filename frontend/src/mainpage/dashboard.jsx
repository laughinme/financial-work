...
import { getSummary,
         getAllocation,
         getDailyPnl,
         getPortfolioValue } from "../api/dashboard";
  ...
  useEffect(() => {
    listTransactions(100,1)
      .then(rows => rows.map(t => ({
        id:t.id, date:t.created_at, type:t.type,
        amount:+t.amount, note:t.comment||""
      })))
      .then(setTx).catch(console.error);
  }, []);
              ...
              <div className="modal-box"
                ...
                <div className="modal-header">
                  ...
                  <button className="modal-close"
                          onClick={()=>setSpark({open:false})}>✕</button>
                </div>
